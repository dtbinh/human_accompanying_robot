...
safe_dis = 5; %safe distance between human and robot
mpc_dt = 1; % sampling time for model discretization used in MPC

% initialize variables
obv_traj = zeros(2,0);%zeros(2,kf); % observed human trajectory
est_state = zeros(5,kf); % estimated human states for every second
