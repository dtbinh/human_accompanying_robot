...
%%% rule-based greedy motion planning method
%{
...
%%% mpc-based greedy motion planning method
% define input arguments
plan_type = inPara.plan_type;
pre_traj = inPara.pre_traj; % no prediction. reflex-based robot
hor = inPara.hor;
safe_dis = inPara.safe_dis;
mpc_dt = inPara.mpc_dt;
h_v = inPara.h_v; % human current speed
...
inPara = struct('pre_traj',pre_traj,'hor',hor,...
...
outPara = agent.pathPlanner(inPara);
opt_x = outPara.opt_x;
opt_u = outPara.opt_u;
