...
static const char * c6_debug_family_names[13] = { "L", "sP", "chi_p", "chi_m_p",
  "i", "nargin", "nargout", "T1", "x", "P", "c", "Wm", "x_m_p" };

/* Function Declarations */
static void initialize_c6_UKF(SFc6_UKFInstanceStruct *chartInstance);
static void initialize_params_c6_UKF(SFc6_UKFInstanceStruct *chartInstance);
static void enable_c6_UKF(SFc6_UKFInstanceStruct *chartInstance);
static void disable_c6_UKF(SFc6_UKFInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_UKF(SFc6_UKFInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c6_UKF(SFc6_UKFInstanceStruct *chartInstance);
static void set_sim_state_c6_UKF(SFc6_UKFInstanceStruct *chartInstance, const
  mxArray *c6_st);
static void finalize_c6_UKF(SFc6_UKFInstanceStruct *chartInstance);
static void sf_c6_UKF(SFc6_UKFInstanceStruct *chartInstance);
static void c6_chartstep_c6_UKF(SFc6_UKFInstanceStruct *chartInstance);
static void initSimStructsc6_UKF(SFc6_UKFInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static void c6_emlrt_marshallIn(SFc6_UKFInstanceStruct *chartInstance, const
  mxArray *c6_x_m_p, const char_T *c6_identifier, real_T c6_y[5]);
static void c6_b_emlrt_marshallIn(SFc6_UKFInstanceStruct *chartInstance, const
  mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[5]);
...
static const mxArray *c6_d_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_c_emlrt_marshallIn(SFc6_UKFInstanceStruct *chartInstance, const
...
static const mxArray *c6_e_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_d_emlrt_marshallIn(SFc6_UKFInstanceStruct *chartInstance, const
  mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[55]);
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static void c6_e_emlrt_marshallIn(SFc6_UKFInstanceStruct *chartInstance, const
  mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[25]);
...
static void c6_eml_error(SFc6_UKFInstanceStruct *chartInstance);
static void c6_eml_scalar_eg(SFc6_UKFInstanceStruct *chartInstance);
static void c6_eml_matlab_zpotrf(SFc6_UKFInstanceStruct *chartInstance, real_T
  c6_A[25], real_T c6_b_A[25], int32_T *c6_info);
static void c6_check_forloop_overflow_error(SFc6_UKFInstanceStruct
  *chartInstance, boolean_T c6_overflow);
static void c6_eml_xgemv(SFc6_UKFInstanceStruct *chartInstance, int32_T c6_m,
  int32_T c6_n, int32_T c6_ia0, int32_T c6_ix0, real_T c6_y[25], int32_T c6_iy0,
  real_T c6_b_y[25]);
static void c6_b_eml_error(SFc6_UKFInstanceStruct *chartInstance);
static void c6_b_eml_scalar_eg(SFc6_UKFInstanceStruct *chartInstance);
static const mxArray *c6_f_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_f_emlrt_marshallIn(SFc6_UKFInstanceStruct *chartInstance,
...
static void c6_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_g_emlrt_marshallIn(SFc6_UKFInstanceStruct *chartInstance,
  const mxArray *c6_b_is_active_c6_UKF, const char_T *c6_identifier);
static uint8_T c6_h_emlrt_marshallIn(SFc6_UKFInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static int32_T c6_b_eml_matlab_zpotrf(SFc6_UKFInstanceStruct *chartInstance,
  real_T c6_A[25]);
static void c6_b_eml_xgemv(SFc6_UKFInstanceStruct *chartInstance, int32_T c6_m,
  int32_T c6_n, int32_T c6_ia0, int32_T c6_ix0, real_T c6_y[25], int32_T c6_iy0);
static void init_dsm_address_info(SFc6_UKFInstanceStruct *chartInstance);
...
static void initialize_c6_UKF(SFc6_UKFInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_UKF = 0U;
}
...
static const mxArray *get_sim_state_c6_UKF(SFc6_UKFInstanceStruct *chartInstance)
{
  ...
  real_T (*c6_x_m_p)[5];
  c6_x_m_p = (real_T (*)[5])ssGetOutputPortSignal(chartInstance->S, 1);
  c6_st = NULL;
  c6_st = NULL;
  c6_y = NULL;
  sf_mex_assign(&c6_y, sf_mex_createcellarray(2), FALSE);
  for (c6_i0 = 0; c6_i0 < 5; c6_i0++) {
    c6_u[c6_i0] = (*c6_x_m_p)[c6_i0];
  }

  c6_b_y = NULL;
  sf_mex_assign(&c6_b_y, sf_mex_create("y", c6_u, 0, 0U, 1U, 0U, 1, 5), FALSE);
  sf_mex_setcell(c6_y, 0, c6_b_y);
  c6_hoistedGlobal = chartInstance->c6_is_active_c6_UKF;
  ...
  mxArray *c6_st)
{
  ...
  for (c6_i1 = 0; c6_i1 < 5; c6_i1++) {
    (*c6_x_m_p)[c6_i1] = c6_dv0[c6_i1];
  }

  chartInstance->c6_is_active_c6_UKF = c6_g_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c6_u, 1)), "is_active_c6_UKF");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_UKF(chartInstance);
...
static void sf_c6_UKF(SFc6_UKFInstanceStruct *chartInstance)
{
  ...
  real_T (*c6_x_m_p)[5];
  real_T (*c6_x)[5];
  c6_Wm = (real_T (*)[11])ssGetInputPortSignal(chartInstance->S, 4);
  c6_c = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c6_P = (real_T (*)[25])ssGetInputPortSignal(chartInstance->S, 2);
  c6_x_m_p = (real_T (*)[5])ssGetOutputPortSignal(chartInstance->S, 1);
  c6_x = (real_T (*)[5])ssGetInputPortSignal(chartInstance->S, 1);
  c6_T1 = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 4U, chartInstance->c6_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c6_T1, 0U);
  for (c6_i2 = 0; c6_i2 < 5; c6_i2++) {
    _SFD_DATA_RANGE_CHECK((*c6_x)[c6_i2], 1U);
  }

  for (c6_i3 = 0; c6_i3 < 5; c6_i3++) {
    _SFD_DATA_RANGE_CHECK((*c6_x_m_p)[c6_i3], 2U);
  }

  for (c6_i4 = 0; c6_i4 < 25; c6_i4++) {
    _SFD_DATA_RANGE_CHECK((*c6_P)[c6_i4], 3U);
  }

  _SFD_DATA_RANGE_CHECK(*c6_c, 4U);
  for (c6_i5 = 0; c6_i5 < 11; c6_i5++) {
    _SFD_DATA_RANGE_CHECK((*c6_Wm)[c6_i5], 5U);
  }

  chartInstance->c6_sfEvent = CALL_EVENT;
  c6_chartstep_c6_UKF(chartInstance);
...
static void c6_chartstep_c6_UKF(SFc6_UKFInstanceStruct *chartInstance)
{
  ...
  real_T (*c6_b_P)[25];
  real_T (*c6_ab_x)[5];
  c6_b_Wm = (real_T (*)[11])ssGetInputPortSignal(chartInstance->S, 4);
  c6_b_c = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c6_b_P = (real_T (*)[25])ssGetInputPortSignal(chartInstance->S, 2);
  c6_b_x_m_p = (real_T (*)[5])ssGetOutputPortSignal(chartInstance->S, 1);
  c6_ab_x = (real_T (*)[5])ssGetInputPortSignal(chartInstance->S, 1);
  c6_b_T1 = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 4U, chartInstance->c6_sfEvent);
  c6_hoistedGlobal = *c6_b_T1;
  c6_b_hoistedGlobal = *c6_b_c;
  c6_T1 = c6_hoistedGlobal;
  for (c6_i6 = 0; c6_i6 < 5; c6_i6++) {
    c6_x[c6_i6] = (*c6_ab_x)[c6_i6];
  }

  for (c6_i7 = 0; c6_i7 < 25; c6_i7++) {
    c6_P[c6_i7] = (*c6_b_P)[c6_i7];
  }

  c6_c = c6_b_hoistedGlobal;
  for (c6_i8 = 0; c6_i8 < 11; c6_i8++) {
    c6_Wm[c6_i8] = (*c6_b_Wm)[c6_i8];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 13U, 13U, c6_debug_family_names,
    c6_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_L, 0U, c6_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c6_sP, 1U, c6_d_sf_marshallOut,
    c6_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c6_chi_p, 2U, c6_e_sf_marshallOut,
    c6_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c6_chi_m_p, 3U, c6_e_sf_marshallOut,
    c6_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_i, 4U, c6_c_sf_marshallOut,
    c6_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_nargout, 6U, c6_c_sf_marshallOut,
    c6_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_T1, 7U, c6_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_x, 8U, c6_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_P, 9U, c6_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c6_c, 10U, c6_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_Wm, 11U, c6_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c6_x_m_p, 12U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 2);
  c6_L = 5.0;
  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 3);
  for (c6_i9 = 0; c6_i9 < 25; c6_i9++) {
    c6_A[c6_i9] = c6_P[c6_i9];
  }
  ...
  c6_info = c6_b_eml_matlab_zpotrf(chartInstance, c6_A);
  c6_b_info = c6_info;
  c6_c_info = c6_b_info;
  c6_d_info = c6_c_info;
  if (c6_d_info == 0) {
  ...
  for (c6_c_j = 2; c6_c_j <= c6_b_jmax; c6_c_j++) {
    c6_b_j = c6_c_j;
    c6_b_a = c6_b_j - 1;
    c6_i10 = c6_b_a;
    c6_c_b = c6_i10;
    ...
    for (c6_b_i = 1; c6_b_i <= c6_i10; c6_b_i++) {
      c6_c_i = c6_b_i;
      c6_A[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
              (real_T)c6_c_i), 1, 5, 1, 0) + 5 * (_SFD_EML_ARRAY_BOUNDS_CHECK("",
              (int32_T)_SFD_INTEGER_CHECK("", (real_T)c6_b_j), 1, 5, 2, 0) - 1))
        - 1] = 0.0;
    }
  }

  for (c6_i11 = 0; c6_i11 < 25; c6_i11++) {
    c6_sP[c6_i11] = c6_A[c6_i11];
  }

  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 4);
  for (c6_i12 = 0; c6_i12 < 5; c6_i12++) {
    c6_c_a[c6_i12] = c6_x[c6_i12];
  }

  for (c6_i13 = 0; c6_i13 < 5; c6_i13++) {
    c6_i14 = 0;
    for (c6_i15 = 0; c6_i15 < 5; c6_i15++) {
      c6_A[c6_i14 + c6_i13] = c6_c_a[c6_i13];
      c6_i14 += 5;
    }
  }

  c6_d_a = c6_c;
  for (c6_i16 = 0; c6_i16 < 25; c6_i16++) {
    c6_e_b[c6_i16] = c6_sP[c6_i16];
  }

  for (c6_i17 = 0; c6_i17 < 25; c6_i17++) {
    c6_e_b[c6_i17] *= c6_d_a;
  }

  for (c6_i18 = 0; c6_i18 < 5; c6_i18++) {
    c6_c_a[c6_i18] = c6_x[c6_i18];
  }

  for (c6_i19 = 0; c6_i19 < 5; c6_i19++) {
    c6_i20 = 0;
    for (c6_i21 = 0; c6_i21 < 5; c6_i21++) {
      c6_y[c6_i20 + c6_i19] = c6_c_a[c6_i19];
      c6_i20 += 5;
    }
  }

  c6_e_a = c6_c;
  for (c6_i22 = 0; c6_i22 < 25; c6_i22++) {
    c6_f_b[c6_i22] = c6_sP[c6_i22];
  }

  for (c6_i23 = 0; c6_i23 < 25; c6_i23++) {
    c6_f_b[c6_i23] *= c6_e_a;
  }

  for (c6_i24 = 0; c6_i24 < 5; c6_i24++) {
    c6_chi_p[c6_i24] = c6_x[c6_i24];
  }

  c6_i25 = 0;
  for (c6_i26 = 0; c6_i26 < 5; c6_i26++) {
    for (c6_i27 = 0; c6_i27 < 5; c6_i27++) {
      c6_chi_p[(c6_i27 + c6_i25) + 5] = c6_A[c6_i27 + c6_i25] + c6_e_b[c6_i27 +
        c6_i25];
    }
  ...
  for (c6_i29 = 0; c6_i29 < 5; c6_i29++) {
    for (c6_i30 = 0; c6_i30 < 5; c6_i30++) {
      c6_chi_p[(c6_i30 + c6_i28) + 30] = c6_y[c6_i30 + c6_i28] - c6_f_b[c6_i30 +
        c6_i28];
    }
  ...
  for (c6_i31 = 0; c6_i31 < 55; c6_i31++) {
    c6_chi_m_p[c6_i31] = 0.0;
  }
  ...
  c6_d_i = 0;
  while (c6_d_i < 11) {
    c6_i = 1.0 + (real_T)c6_d_i;
    CV_EML_FOR(0, 1, 0, 1);
    _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 9);
    c6_f_a = c6_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_g_b = c6_T1;
    c6_b_y = c6_f_a * c6_g_b;
    c6_b_x = c6_b_y;
    c6_c_x = c6_b_x;
    c6_c_x = muDoubleScalarSin(c6_c_x);
    c6_g_a = c6_chi_p[1 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_h_b = c6_c_x;
    c6_c_y = c6_g_a * c6_h_b;
    c6_b_A = c6_c_y;
    c6_B = c6_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_d_x = c6_b_A;
    c6_d_y = c6_B;
    c6_e_x = c6_d_x;
    c6_e_y = c6_d_y;
    c6_f_y = c6_e_x / c6_e_y;
    c6_h_a = c6_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_i_b = c6_T1;
    c6_g_y = c6_h_a * c6_i_b;
    c6_f_x = c6_g_y;
    c6_g_x = c6_f_x;
    c6_g_x = muDoubleScalarCos(c6_g_x);
    c6_i_a = c6_chi_p[3 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_j_b = 1.0 - c6_g_x;
    c6_h_y = c6_i_a * c6_j_b;
    c6_c_A = c6_h_y;
    c6_b_B = c6_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_h_x = c6_c_A;
    c6_i_y = c6_b_B;
    c6_i_x = c6_h_x;
    c6_j_y = c6_i_y;
    c6_k_y = c6_i_x / c6_j_y;
    c6_chi_m_p[5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_m_p",
      (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)] = (c6_chi_p[5 *
      ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_p", (int32_T)
      _SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)] + c6_f_y) - c6_k_y;
    _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 10);
    c6_j_a = c6_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_k_b = c6_T1;
    c6_l_y = c6_j_a * c6_k_b;
    c6_j_x = c6_l_y;
    c6_k_x = c6_j_x;
    c6_k_x = muDoubleScalarCos(c6_k_x);
    c6_k_a = c6_k_x;
    c6_l_b = c6_chi_p[1 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_m_y = c6_k_a * c6_l_b;
    c6_l_a = c6_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_m_b = c6_T1;
    c6_n_y = c6_l_a * c6_m_b;
    c6_l_x = c6_n_y;
    c6_m_x = c6_l_x;
    c6_m_x = muDoubleScalarSin(c6_m_x);
    c6_m_a = c6_m_x;
    c6_n_b = c6_chi_p[3 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_o_y = c6_m_a * c6_n_b;
    c6_chi_m_p[1 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_m_p",
                         (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) -
                        1)] = c6_m_y - c6_o_y;
    _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 11);
    c6_n_a = c6_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_o_b = c6_T1;
    c6_p_y = c6_n_a * c6_o_b;
    c6_n_x = c6_p_y;
    c6_o_x = c6_n_x;
    c6_o_x = muDoubleScalarCos(c6_o_x);
    c6_o_a = c6_chi_p[1 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_p_b = 1.0 - c6_o_x;
    c6_q_y = c6_o_a * c6_p_b;
    c6_d_A = c6_q_y;
    c6_c_B = c6_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_p_x = c6_d_A;
    c6_r_y = c6_c_B;
    c6_q_x = c6_p_x;
    c6_s_y = c6_r_y;
    c6_t_y = c6_q_x / c6_s_y;
    c6_p_a = c6_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_q_b = c6_T1;
    c6_u_y = c6_p_a * c6_q_b;
    c6_r_x = c6_u_y;
    c6_s_x = c6_r_x;
    c6_s_x = muDoubleScalarSin(c6_s_x);
    c6_q_a = c6_chi_p[3 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_r_b = c6_s_x;
    c6_v_y = c6_q_a * c6_r_b;
    c6_e_A = c6_v_y;
    c6_d_B = c6_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_t_x = c6_e_A;
    c6_w_y = c6_d_B;
    c6_u_x = c6_t_x;
    c6_x_y = c6_w_y;
    c6_y_y = c6_u_x / c6_x_y;
    c6_chi_m_p[2 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_m_p",
                         (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) -
                        1)] = (c6_t_y + c6_chi_p[2 + 5 * ((int32_T)(real_T)
      _SFD_EML_ARRAY_BOUNDS_CHECK("chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i),
      1, 11, 2, 0) - 1)]) + c6_y_y;
    _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 12);
    c6_r_a = c6_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_s_b = c6_T1;
    c6_ab_y = c6_r_a * c6_s_b;
    c6_v_x = c6_ab_y;
    c6_w_x = c6_v_x;
    c6_w_x = muDoubleScalarSin(c6_w_x);
    c6_s_a = c6_chi_p[1 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_t_b = c6_w_x;
    c6_bb_y = c6_s_a * c6_t_b;
    c6_t_a = c6_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_u_b = c6_T1;
    c6_cb_y = c6_t_a * c6_u_b;
    c6_x_x = c6_cb_y;
    c6_y_x = c6_x_x;
    c6_y_x = muDoubleScalarCos(c6_y_x);
    c6_u_a = c6_chi_p[3 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) - 1)];
    c6_v_b = c6_y_x;
    c6_db_y = c6_u_a * c6_v_b;
    c6_chi_m_p[3 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_m_p",
                         (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) -
                        1)] = c6_bb_y + c6_db_y;
    _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 13);
    c6_chi_m_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_m_p",
                         (int32_T)_SFD_INTEGER_CHECK("i", c6_i), 1, 11, 2, 0) -
                        1)] = c6_chi_p[4 + 5 * ((int32_T)(real_T)
      _SFD_EML_ARRAY_BOUNDS_CHECK("chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c6_i),
      1, 11, 2, 0) - 1)];
    c6_d_i++;
  ...
  for (c6_i32 = 0; c6_i32 < 55; c6_i32++) {
    c6_v_a[c6_i32] = c6_chi_m_p[c6_i32];
  }

  for (c6_i33 = 0; c6_i33 < 11; c6_i33++) {
    c6_w_b[c6_i33] = c6_Wm[c6_i33];
  }
  ...
  for (c6_i36 = 0; c6_i36 < 5; c6_i36++) {
    c6_c_a[c6_i36] = c6_x_m_p[c6_i36];
  }

  for (c6_i37 = 0; c6_i37 < 5; c6_i37++) {
    c6_x_m_p[c6_i37] = c6_c_a[c6_i37];
  }

  for (c6_i38 = 0; c6_i38 < 5; c6_i38++) {
    c6_c_a[c6_i38] = c6_x_m_p[c6_i38];
  }

  for (c6_i39 = 0; c6_i39 < 5; c6_i39++) {
    c6_x_m_p[c6_i39] = c6_c_a[c6_i39];
  }

  for (c6_i40 = 0; c6_i40 < 5; c6_i40++) {
    c6_x_m_p[c6_i40] = 0.0;
    c6_i41 = 0;
    for (c6_i42 = 0; c6_i42 < 11; c6_i42++) {
      c6_x_m_p[c6_i40] += c6_v_a[c6_i41 + c6_i40] * c6_w_b[c6_i42];
      c6_i41 += 5;
    }
  }
  ...
  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, -15);
  _SFD_SYMBOL_SCOPE_POP();
  for (c6_i43 = 0; c6_i43 < 5; c6_i43++) {
    (*c6_b_x_m_p)[c6_i43] = c6_x_m_p[c6_i43];
  }
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  real_T c6_u[5];
  const mxArray *c6_y = NULL;
  SFc6_UKFInstanceStruct *chartInstance;
  chartInstance = (SFc6_UKFInstanceStruct *)chartInstanceVoid;
  c6_mxArrayOutData = NULL;
  for (c6_i44 = 0; c6_i44 < 5; c6_i44++) {
    c6_b_inData[c6_i44] = (*(real_T (*)[5])c6_inData)[c6_i44];
  }

  for (c6_i45 = 0; c6_i45 < 5; c6_i45++) {
    c6_u[c6_i45] = c6_b_inData[c6_i45];
  }

  c6_y = NULL;
  sf_mex_assign(&c6_y, sf_mex_create("y", c6_u, 0, 0U, 1U, 0U, 1, 5), FALSE);
  ...
  mxArray *c6_x_m_p, const char_T *c6_identifier, real_T c6_y[5])
{
  ...
  c6_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_x_m_p), &c6_thisId, c6_y);
  sf_mex_destroy(&c6_x_m_p);
}
  ...
  mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[5])
{
  real_T c6_dv1[5];
  int32_T c6_i46;
  sf_mex_import(c6_parentId, sf_mex_dup(c6_u), c6_dv1, 1, 0, 0U, 1, 0U, 1, 5);
  for (c6_i46 = 0; c6_i46 < 5; c6_i46++) {
    c6_y[c6_i46] = c6_dv1[c6_i46];
  }
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  SFc6_UKFInstanceStruct *chartInstance;
  chartInstance = (SFc6_UKFInstanceStruct *)chartInstanceVoid;
  c6_x_m_p = sf_mex_dup(c6_mxArrayInData);
  c6_identifier = c6_varName;
  c6_thisId.fIdentifier = c6_identifier;
  c6_thisId.fParent = NULL;
  c6_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_x_m_p), &c6_thisId, c6_y);
  sf_mex_destroy(&c6_x_m_p);
  for (c6_i47 = 0; c6_i47 < 5; c6_i47++) {
    (*(real_T (*)[5])c6_outData)[c6_i47] = c6_y[c6_i47];
  }
  ...
  *c6_inData)
{
  ...
  chartInstance = (SFc6_UKFInstanceStruct *)chartInstanceVoid;
  c6_mxArrayOutData = NULL;
  for (c6_i48 = 0; c6_i48 < 11; c6_i48++) {
    c6_b_inData[c6_i48] = (*(real_T (*)[11])c6_inData)[c6_i48];
  }

  for (c6_i49 = 0; c6_i49 < 11; c6_i49++) {
    c6_u[c6_i49] = c6_b_inData[c6_i49];
  }

  c6_y = NULL;
  sf_mex_assign(&c6_y, sf_mex_create("y", c6_u, 0, 0U, 1U, 0U, 1, 11), FALSE);
  sf_mex_assign(&c6_mxArrayOutData, c6_y, FALSE);
  return c6_mxArrayOutData;
}
  ...
  *c6_inData)
{
  ...
  c6_mxArrayOutData = NULL;
  c6_i50 = 0;
  for (c6_i51 = 0; c6_i51 < 5; c6_i51++) {
    for (c6_i52 = 0; c6_i52 < 5; c6_i52++) {
      c6_b_inData[c6_i52 + c6_i50] = (*(real_T (*)[25])c6_inData)[c6_i52 +
        c6_i50];
    }
  ...
  c6_i53 = 0;
  for (c6_i54 = 0; c6_i54 < 5; c6_i54++) {
    for (c6_i55 = 0; c6_i55 < 5; c6_i55++) {
      c6_u[c6_i55 + c6_i53] = c6_b_inData[c6_i55 + c6_i53];
    }
  ...
  c6_y = NULL;
  sf_mex_assign(&c6_y, sf_mex_create("y", c6_u, 0, 0U, 1U, 0U, 2, 5, 5), FALSE);
  sf_mex_assign(&c6_mxArrayOutData, c6_y, FALSE);
  return c6_mxArrayOutData;
}
  ...
  *c6_inData)
{
  ...
  c6_mxArrayOutData = NULL;
  c6_i56 = 0;
  for (c6_i57 = 0; c6_i57 < 11; c6_i57++) {
    for (c6_i58 = 0; c6_i58 < 5; c6_i58++) {
      c6_b_inData[c6_i58 + c6_i56] = (*(real_T (*)[55])c6_inData)[c6_i58 +
        c6_i56];
    }
  ...
  c6_i59 = 0;
  for (c6_i60 = 0; c6_i60 < 11; c6_i60++) {
    for (c6_i61 = 0; c6_i61 < 5; c6_i61++) {
      c6_u[c6_i61 + c6_i59] = c6_b_inData[c6_i61 + c6_i59];
    }
  ...
  c6_y = NULL;
  sf_mex_assign(&c6_y, sf_mex_create("y", c6_u, 0, 0U, 1U, 0U, 2, 5, 11), FALSE);
  sf_mex_assign(&c6_mxArrayOutData, c6_y, FALSE);
  return c6_mxArrayOutData;
}
  ...
  mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[55])
{
  real_T c6_dv2[55];
  int32_T c6_i62;
  sf_mex_import(c6_parentId, sf_mex_dup(c6_u), c6_dv2, 1, 0, 0U, 1, 0U, 2, 5, 11);
  for (c6_i62 = 0; c6_i62 < 55; c6_i62++) {
    c6_y[c6_i62] = c6_dv2[c6_i62];
  }
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  SFc6_UKFInstanceStruct *chartInstance;
  chartInstance = (SFc6_UKFInstanceStruct *)chartInstanceVoid;
  c6_chi_m_p = sf_mex_dup(c6_mxArrayInData);
  c6_identifier = c6_varName;
  c6_thisId.fIdentifier = c6_identifier;
  c6_thisId.fParent = NULL;
  c6_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_chi_m_p), &c6_thisId, c6_y);
  sf_mex_destroy(&c6_chi_m_p);
  c6_i63 = 0;
  for (c6_i64 = 0; c6_i64 < 11; c6_i64++) {
    for (c6_i65 = 0; c6_i65 < 5; c6_i65++) {
      (*(real_T (*)[55])c6_outData)[c6_i65 + c6_i63] = c6_y[c6_i65 + c6_i63];
    }
  ...
  mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[25])
{
  real_T c6_dv3[25];
  int32_T c6_i66;
  sf_mex_import(c6_parentId, sf_mex_dup(c6_u), c6_dv3, 1, 0, 0U, 1, 0U, 2, 5, 5);
  for (c6_i66 = 0; c6_i66 < 25; c6_i66++) {
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  SFc6_UKFInstanceStruct *chartInstance;
  chartInstance = (SFc6_UKFInstanceStruct *)chartInstanceVoid;
  c6_sP = sf_mex_dup(c6_mxArrayInData);
  c6_identifier = c6_varName;
  c6_thisId.fIdentifier = c6_identifier;
  c6_thisId.fParent = NULL;
  c6_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_sP), &c6_thisId, c6_y);
  sf_mex_destroy(&c6_sP);
  c6_i67 = 0;
  for (c6_i68 = 0; c6_i68 < 5; c6_i68++) {
    for (c6_i69 = 0; c6_i69 < 5; c6_i69++) {
      (*(real_T (*)[25])c6_outData)[c6_i69 + c6_i67] = c6_y[c6_i69 + c6_i67];
    }
...
const mxArray *sf_c6_UKF_get_eml_resolved_functions_info(void)
{
  ...
  sf_mex_assign(&c6_nameCaptureInfo, sf_mex_createstruct("structure", 2, 79, 1),
                FALSE);
...
static void c6_info_helper(const mxArray **c6_info)
{
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("chol"), "name", "name", 0);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/chol.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1344504434U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/chol.m"), "context",
                  "context", 1);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_tolower"), "name", "name",
                  1);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_tolower.m"), "resolved",
                  "resolved", 1);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1363742670U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/chol.m!cholesky"),
                  "context", "context", 3);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("ismatrix"), "name", "name", 3);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 3);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/ismatrix.m"), "resolved",
                  "resolved", 3);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1331337258U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                  "resolved", "resolved", 4);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1346542740U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 5);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("intmax"), "name", "name", 5);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 5);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
                  "resolved", 5);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1362294282U), "fileTimeLo",
                  "fileTimeLo", 5);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 5);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/chol.m!cholesky"),
                  "context", "context", 6);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_error"), "name", "name", 6);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/chol.m!cholesky"),
                  "context", "context", 7);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_xpotrf"), "name", "name",
                  7);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/eml_xpotrf.m"),
                  "resolved", "resolved", 7);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1286851208U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/eml_xpotrf.m"),
                  "context", "context", 8);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_lapack_xpotrf"), "name",
                  "name", 8);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/internal/eml_lapack_xpotrf.m"),
                  "resolved", "resolved", 8);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1286851212U), "fileTimeLo",
                  "fileTimeLo", 8);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 8);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/internal/eml_lapack_xpotrf.m"),
                  "context", "context", 9);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_matlab_zpotrf"), "name",
                  "name", 9);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 9);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zpotrf.m"),
                  "resolved", "resolved", 9);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1286851224U), "fileTimeLo",
                  "fileTimeLo", 9);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 9);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m"), "resolved",
                  "resolved", 11);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1286851196U), "fileTimeLo",
                  "fileTimeLo", 11);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 11);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1286851178U), "fileTimeLo",
                  "fileTimeLo", 13);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 13);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1286851180U), "fileTimeLo",
                  "fileTimeLo", 15);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 15);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1299109168U), "fileTimeLo",
                  "fileTimeLo", 20);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 20);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xdotc.m"), "context",
                  "context", 21);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_xdot"), "name", "name", 21);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 21);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xdot.m"), "resolved",
                  "resolved", 21);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1363742668U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 22);
  sf_mex_assign(&c6_rhs22, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs22, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xdot.m!below_threshold"),
                  "context", "context", 23);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("length"), "name", "name", 23);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 23);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m"), "resolved",
                  "resolved", 23);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1303178606U), "fileTimeLo",
                  "fileTimeLo", 23);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 23);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 23);
  sf_mex_assign(&c6_rhs23, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs23, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 24);
  sf_mex_assign(&c6_rhs24, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs24, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 25);
  sf_mex_assign(&c6_rhs25, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs25, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xdot.m"),
                  "context", "context", 26);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_refblas_xdot"), "name",
                  "name", 26);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 26);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1299109172U), "fileTimeLo",
                  "fileTimeLo", 26);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 26);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 26);
  sf_mex_assign(&c6_rhs26, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs26, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdot.m"),
                  "context", "context", 27);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_refblas_xdotx"), "name",
                  "name", 27);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1360314750U), "fileTimeLo",
                  "fileTimeLo", 27);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 27);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 27);
  sf_mex_assign(&c6_rhs27, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs27, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 28);
  sf_mex_assign(&c6_rhs28, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs28, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 29);
  sf_mex_assign(&c6_rhs29, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs29, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 30);
  sf_mex_assign(&c6_rhs30, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs30, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 31);
  sf_mex_assign(&c6_rhs31, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs31, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 32);
  sf_mex_assign(&c6_rhs32, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs32, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 33);
  sf_mex_assign(&c6_rhs33, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs33, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zpotrf.m"),
                  "context", "context", 34);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_xgemv"), "name", "name",
                  34);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 34);
  sf_mex_assign(&c6_rhs34, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs34, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 35);
  sf_mex_assign(&c6_rhs35, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs35, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemv.m!below_threshold"),
                  "context", "context", 36);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("length"), "name", "name", 36);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 36);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m"), "resolved",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 36);
  sf_mex_assign(&c6_rhs36, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs36, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemv.m!below_threshold"),
                  "context", "context", 37);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("intmax"), "name", "name", 37);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 37);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 37);
  sf_mex_assign(&c6_rhs37, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs37, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemv.m!below_threshold"),
                  "context", "context", 38);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("mtimes"), "name", "name", 38);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 38);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
                  "resolved", 38);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1363742678U), "fileTimeLo",
                  "fileTimeLo", 38);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 38);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 38);
  sf_mex_assign(&c6_rhs38, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs38, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 39);
  sf_mex_assign(&c6_rhs39, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs39, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 40);
  sf_mex_assign(&c6_rhs40, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs40, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 41);
  sf_mex_assign(&c6_rhs41, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs41, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemv.m"),
                  "context", "context", 42);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_refblas_xgemv"), "name",
                  "name", 42);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 42);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1360314752U), "fileTimeLo",
                  "fileTimeLo", 42);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 42);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 42);
  sf_mex_assign(&c6_rhs42, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs42, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 43);
  sf_mex_assign(&c6_rhs43, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs43, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 44);
  sf_mex_assign(&c6_rhs44, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs44, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 45);
  sf_mex_assign(&c6_rhs45, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs45, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 46);
  sf_mex_assign(&c6_rhs46, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs46, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 47);
  sf_mex_assign(&c6_rhs47, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs47, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
                  "resolved", 48);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1363742666U), "fileTimeLo",
                  "fileTimeLo", 48);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 48);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 48);
  sf_mex_assign(&c6_rhs48, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs48, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1363742672U), "fileTimeLo",
                  "fileTimeLo", 49);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 49);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 49);
  sf_mex_assign(&c6_rhs49, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs49, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 50);
  sf_mex_assign(&c6_rhs50, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs50, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xscal.m!below_threshold"),
                  "context", "context", 51);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("length"), "name", "name", 51);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 51);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m"), "resolved",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 51);
  sf_mex_assign(&c6_rhs51, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs51, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 52);
  sf_mex_assign(&c6_rhs52, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs52, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 53);
  sf_mex_assign(&c6_rhs53, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs53, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xscal.m"),
                  "context", "context", 54);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_refblas_xscal"), "name",
                  "name", 54);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 54);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1299109184U), "fileTimeLo",
                  "fileTimeLo", 54);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 54);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 54);
  sf_mex_assign(&c6_rhs54, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs54, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 55);
  sf_mex_assign(&c6_rhs55, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs55, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 56);
  sf_mex_assign(&c6_rhs56, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs56, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 57);
  sf_mex_assign(&c6_rhs57, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs57, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 58);
  sf_mex_assign(&c6_rhs58, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs58, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 59);
  sf_mex_assign(&c6_rhs59, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs59, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 60);
  sf_mex_assign(&c6_rhs60, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs60, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("mtimes"), "name", "name", 61);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 61);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 61);
  sf_mex_assign(&c6_rhs61, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs61, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, sf_mex_duplicatearraysafe(&c6_lhs61), "lhs", "lhs",
                  61);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(""), "context", "context", 62);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("sin"), "name", "name", 62);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 62);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m"), "resolved",
                  "resolved", 62);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1343862786U), "fileTimeLo",
                  "fileTimeLo", 62);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 62);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 62);
  sf_mex_assign(&c6_rhs62, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs62, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1286851136U), "fileTimeLo",
                  "fileTimeLo", 63);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 63);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 63);
  sf_mex_assign(&c6_rhs63, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs63, sf_mex_createcellarray(0), FALSE);
...
static void c6_b_info_helper(const mxArray **c6_info)
{
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(""), "context", "context", 64);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("mrdivide"), "name", "name", 64);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 64);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
                  "resolved", 64);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1373338908U), "fileTimeLo",
                  "fileTimeLo", 64);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 64);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1319762366U), "mFileTimeLo",
                  "mFileTimeLo", 64);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 64);
  sf_mex_assign(&c6_rhs64, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs64, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 65);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("rdivide"), "name", "name", 65);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 65);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "resolved",
                  "resolved", 65);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1363742680U), "fileTimeLo",
                  "fileTimeLo", 65);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 65);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 65);
  sf_mex_assign(&c6_rhs65, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs65, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 66);
  sf_mex_assign(&c6_rhs66, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs66, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 67);
  sf_mex_assign(&c6_rhs67, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs67, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 68);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("eml_div"), "name", "name", 68);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 68);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 68);
  sf_mex_assign(&c6_rhs68, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs68, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, sf_mex_duplicatearraysafe(&c6_lhs68), "lhs", "lhs",
                  68);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(""), "context", "context", 69);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("cos"), "name", "name", 69);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 69);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m"), "resolved",
                  "resolved", 69);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1343862772U), "fileTimeLo",
                  "fileTimeLo", 69);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 69);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 69);
  sf_mex_assign(&c6_rhs69, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs69, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(1286851122U), "fileTimeLo",
                  "fileTimeLo", 70);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 70);
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 70);
  sf_mex_assign(&c6_rhs70, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs70, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 71);
  sf_mex_assign(&c6_rhs71, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs71, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 72);
  sf_mex_assign(&c6_rhs72, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs72, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 73);
  sf_mex_assign(&c6_rhs73, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs73, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 74);
  sf_mex_assign(&c6_rhs74, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs74, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m!below_threshold"),
                  "context", "context", 75);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("mtimes"), "name", "name", 75);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 75);
  sf_mex_addfield(*c6_info, c6_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 75);
  sf_mex_assign(&c6_rhs75, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs75, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 76);
  sf_mex_assign(&c6_rhs76, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs76, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 77);
  sf_mex_assign(&c6_rhs77, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs77, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c6_info, c6_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 78);
  sf_mex_assign(&c6_rhs78, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c6_lhs78, sf_mex_createcellarray(0), FALSE);
...
{
  int32_T c6_i70;
  static char_T c6_cv0[48] = { 'C', 'o', 'd', 'e', 'r', ':', 'M', 'A', 'T', 'L',
  ...
  char_T c6_u[48];
  const mxArray *c6_y = NULL;
  for (c6_i70 = 0; c6_i70 < 48; c6_i70++) {
    c6_u[c6_i70] = c6_cv0[c6_i70];
  }

  c6_y = NULL;
  sf_mex_assign(&c6_y, sf_mex_create("y", c6_u, 10, 0U, 1U, 0U, 2, 1, 48), FALSE);
...
{
  int32_T c6_i71;
  for (c6_i71 = 0; c6_i71 < 25; c6_i71++) {
    c6_b_A[c6_i71] = c6_A[c6_i71];
  }

  *c6_info = c6_b_eml_matlab_zpotrf(chartInstance, c6_b_A);
}
  ...
  *chartInstance, boolean_T c6_overflow)
{
  ...
  if (!c6_overflow) {
    ...
    for (c6_i72 = 0; c6_i72 < 34; c6_i72++) {
      c6_u[c6_i72] = c6_cv1[c6_i72];
    }

    c6_y = NULL;
    sf_mex_assign(&c6_y, sf_mex_create("y", c6_u, 10, 0U, 1U, 0U, 2, 1, 34),
                  FALSE);
    for (c6_i73 = 0; c6_i73 < 23; c6_i73++) {
      c6_b_u[c6_i73] = c6_cv2[c6_i73];
    }
...
{
  int32_T c6_i74;
  for (c6_i74 = 0; c6_i74 < 25; c6_i74++) {
    c6_b_y[c6_i74] = c6_y[c6_i74];
  }

  c6_b_eml_xgemv(chartInstance, c6_m, c6_n, c6_ia0, c6_ix0, c6_b_y, c6_iy0);
}

static void c6_b_eml_error(SFc6_UKFInstanceStruct *chartInstance)
{
  int32_T c6_i75;
  static char_T c6_cv3[19] = { 'C', 'o', 'd', 'e', 'r', ':', 'M', 'A', 'T', 'L',
    'A', 'B', ':', 'p', 'o', 's', 'd', 'e', 'f' };

  char_T c6_u[19];
  const mxArray *c6_y = NULL;
  for (c6_i75 = 0; c6_i75 < 19; c6_i75++) {
    c6_u[c6_i75] = c6_cv3[c6_i75];
  }

  c6_y = NULL;
  sf_mex_assign(&c6_y, sf_mex_create("y", c6_u, 10, 0U, 1U, 0U, 2, 1, 19), FALSE);
  sf_mex_call_debug("error", 0U, 1U, 14, sf_mex_call_debug("message", 1U, 1U, 14,
    c6_y));
}
  ...
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId)
{
  int32_T c6_y;
  int32_T c6_i76;
  sf_mex_import(c6_parentId, sf_mex_dup(c6_u), &c6_i76, 1, 6, 0U, 0, 0U, 0);
  c6_y = c6_i76;
  sf_mex_destroy(&c6_u);
  return c6_y;
}
  ...
  const mxArray *c6_b_is_active_c6_UKF, const char_T *c6_identifier)
{
  ...
  c6_thisId.fIdentifier = c6_identifier;
  c6_thisId.fParent = NULL;
  c6_y = c6_h_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_b_is_active_c6_UKF),
    &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_UKF);
  return c6_y;
}
  ...
  while ((exitg1 == FALSE) && (c6_j < 6)) {
    ...
    if (c6_e_n < 1) {
      ...
      for (c6_k = 1; c6_k <= c6_f_n; c6_k++) {
        c6_d += c6_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", (real_T)c6_ix), 1, 25, 1, 0) - 1] *
          c6_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
          (real_T)c6_iy), 1, 25, 1, 0) - 1];
        c6_d_a = c6_ix + 5;
        c6_ix = c6_d_a;
        c6_e_a = c6_iy + 5;
        c6_iy = c6_e_a;
    ...
    c6_ajj = c6_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      (real_T)c6_jj), 1, 25, 1, 0) - 1] - c6_d;
    if (c6_ajj > 0.0) {
      c6_ajj = muDoubleScalarSqrt(c6_ajj);
      c6_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
        (real_T)c6_jj), 1, 25, 1, 0) - 1] = c6_ajj;
      if (c6_b_j < 5) {
        c6_d_b = c6_b_j;
        c6_nmj = 5 - c6_d_b;
        c6_f_a = c6_b_j;
        ...
        for (c6_b_k = 1; c6_b_k <= c6_b_jm1; c6_b_k++) {
          c6_c_k = c6_b_k;
          c6_A[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                  (real_T)c6_b_j), 1, 5, 1, 0) + 5 *
                (_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                   (real_T)c6_c_k), 1, 5, 2, 0) - 1)) - 1] = c6_A
            [(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                (real_T)c6_b_j), 1, 5, 1, 0) + 5 * (_SFD_EML_ARRAY_BOUNDS_CHECK(
                "", (int32_T)_SFD_INTEGER_CHECK("", (real_T)c6_c_k), 1, 5, 2, 0)
               - 1)) - 1];
        }

        c6_b_eml_xgemv(chartInstance, c6_nmj, c6_jm1, c6_jp1 + 1, c6_b_j, c6_A,
                       c6_jp1j);
        c6_c_jm1 = c6_jm1;
        c6_g_b = c6_c_jm1;
        c6_h_b = c6_g_b;
        ...
        for (c6_d_k = 1; c6_d_k <= c6_c_jm1; c6_d_k++) {
          c6_c_k = c6_d_k;
          c6_A[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                  (real_T)c6_b_j), 1, 5, 1, 0) + 5 *
                (_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
        ...
        if (c6_n_a > c6_l_b) {
          ...
          c6_d_overflow = (c6_l_b > 2147483646);
        }
        ...
        for (c6_e_k = c6_i_ix0; c6_e_k <= c6_i77; c6_e_k++) {
          c6_f_k = c6_e_k;
          c6_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c6_f_k), 1, 25, 1, 0) - 1] = c6_j_a *
            c6_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c6_f_k), 1, 25, 1, 0) - 1];
        }
      }
  ...
  int32_T c6_n, int32_T c6_ia0, int32_T c6_ix0, real_T c6_y[25], int32_T c6_iy0)
{
  ...
  if (c6_b_m < 1) {
    ...
    c6_TRANSA = 'N';
    c6_var = c6_c_m;
    c6_m_t = (ptrdiff_t)(c6_var);
    c6_b_var = c6_c_n;
    c6_n_t = (ptrdiff_t)(c6_b_var);
    c6_lda_t = (ptrdiff_t)(5);
    c6_incx_t = (ptrdiff_t)(5);
    c6_incy_t = (ptrdiff_t)(1);
    c6_alpha1_t = (double *)(&c6_alpha1);
    c6_beta1_t = (double *)(&c6_beta1);
    c6_yiy0_t = (double *)(&c6_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c6_c_iy0), 1, 25, 1, 0) - 1]);
    c6_yix0_t = (double *)(&c6_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c6_c_ix0), 1, 25, 1, 0) - 1]);
    c6_yia0_t = (double *)(&c6_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c6_c_ia0), 1, 25, 1, 0) - 1]);
    dgemv(&c6_TRANSA, &c6_m_t, &c6_n_t, c6_alpha1_t, c6_yia0_t, &c6_lda_t,
          c6_yix0_t, &c6_incx_t, c6_beta1_t, c6_yiy0_t, &c6_incy_t);
  }
}
...
void sf_c6_UKF_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_UKF_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_UKF_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c6_UKF(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[9],T\"x_m_p\",},{M[8],M[0],T\"is_active_c6_UKF\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_UKF_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc6_UKFInstanceStruct *chartInstance;
    chartInstance = (SFc6_UKFInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(2U, *c6_x_m_p);
          _SFD_SET_DATA_VALUE_PTR(3U, *c6_P);
          _SFD_SET_DATA_VALUE_PTR(4U, c6_c);
          _SFD_SET_DATA_VALUE_PTR(5U, *c6_Wm);
        }
      }
    } else {
...
static void sf_opaque_initialize_c6_UKF(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_UKFInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c6_UKF((SFc6_UKFInstanceStruct*) chartInstanceVar);
  initialize_c6_UKF((SFc6_UKFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_UKF(void *chartInstanceVar)
{
  enable_c6_UKF((SFc6_UKFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_UKF(void *chartInstanceVar)
{
  disable_c6_UKF((SFc6_UKFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_UKF(void *chartInstanceVar)
{
  sf_c6_UKF((SFc6_UKFInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_UKF(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_UKF((SFc6_UKFInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_UKF();/* state var info */
...
extern void sf_internal_set_sim_state_c6_UKF(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c6_UKF((SFc6_UKFInstanceStruct*)chartInfo->chartInstance,
                       mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_UKF(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_UKF(S);
}

static void sf_opaque_set_sim_state_c6_UKF(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c6_UKF(S, st);
}

static void sf_opaque_terminate_c6_UKF(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_UKFInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_UKF_optimization_info();
    }

    finalize_c6_UKF((SFc6_UKFInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_UKF((SFc6_UKFInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_UKF(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c6_UKF((SFc6_UKFInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c6_UKF(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c6_UKF(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_UKF(SimStruct *S)
{
  SFc6_UKFInstanceStruct *chartInstance;
  chartInstance = (SFc6_UKFInstanceStruct *)utMalloc(sizeof
    (SFc6_UKFInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_UKFInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c6_UKF;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c6_UKF;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_UKF;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_UKF;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_UKF;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c6_UKF;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c6_UKF;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c6_UKF;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_UKF;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_UKF;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_UKF;
...
void c6_UKF_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_UKF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_UKF(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_UKF_method_dispatcher.\n"
