...
static void sf_c4_UKF(SFc4_UKFInstanceStruct *chartInstance);
...
static void c4_b_eml_scalar_eg(SFc4_UKFInstanceStruct *chartInstance);
...
static void c4_chartstep_c4_UKF(SFc4_UKFInstanceStruct *chartInstance)
{
  ...
  c4_ab_x = (real_T (*)[5])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c4_i12 = 0; c4_i12 < 5; c4_i12++) {
    c4_c_a[c4_i12] = c4_x[c4_i12];
  }

  for (c4_i13 = 0; c4_i13 < 5; c4_i13++) {
    c4_i14 = 0;
    for (c4_i15 = 0; c4_i15 < 5; c4_i15++) {
      c4_A[c4_i14 + c4_i13] = c4_c_a[c4_i13];
      c4_i14 += 5;
    }
  }
  ...
  while (c4_d_i < 11) {
    ...
    c4_f_a = c4_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_g_b = c4_T1;
    c4_b_y = c4_f_a * c4_g_b;
    c4_b_x = c4_b_y;
    c4_c_x = c4_b_x;
    c4_c_x = muDoubleScalarSin(c4_c_x);
    c4_g_a = c4_chi_p[1 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_h_b = c4_c_x;
    c4_c_y = c4_g_a * c4_h_b;
    c4_b_A = c4_c_y;
    c4_B = c4_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_d_x = c4_b_A;
    c4_d_y = c4_B;
    c4_e_x = c4_d_x;
    ...
    c4_h_a = c4_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_i_b = c4_T1;
    c4_g_y = c4_h_a * c4_i_b;
    c4_f_x = c4_g_y;
    c4_g_x = c4_f_x;
    c4_g_x = muDoubleScalarCos(c4_g_x);
    c4_i_a = c4_chi_p[3 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_j_b = 1.0 - c4_g_x;
    c4_h_y = c4_i_a * c4_j_b;
    c4_c_A = c4_h_y;
    c4_b_B = c4_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_h_x = c4_c_A;
    c4_i_y = c4_b_B;
    c4_i_x = c4_h_x;
    c4_j_y = c4_i_y;
    c4_k_y = c4_i_x / c4_j_y;
    c4_chi_m_p[5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_m_p",
      (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)] = (c4_chi_p[5 *
      ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_p", (int32_T)
      _SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)] + c4_f_y) - c4_k_y;
    _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 10);
    c4_j_a = c4_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_k_b = c4_T1;
    c4_l_y = c4_j_a * c4_k_b;
    c4_j_x = c4_l_y;
    c4_k_x = c4_j_x;
    c4_k_x = muDoubleScalarCos(c4_k_x);
    c4_k_a = c4_k_x;
    c4_l_b = c4_chi_p[1 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_m_y = c4_k_a * c4_l_b;
    c4_l_a = c4_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_m_b = c4_T1;
    c4_n_y = c4_l_a * c4_m_b;
    c4_l_x = c4_n_y;
    c4_m_x = c4_l_x;
    c4_m_x = muDoubleScalarSin(c4_m_x);
    c4_m_a = c4_m_x;
    c4_n_b = c4_chi_p[3 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_o_y = c4_m_a * c4_n_b;
    c4_chi_m_p[1 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_m_p",
                         (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) -
                        1)] = c4_m_y - c4_o_y;
    _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 11);
    c4_n_a = c4_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_o_b = c4_T1;
    c4_p_y = c4_n_a * c4_o_b;
    c4_n_x = c4_p_y;
    c4_o_x = c4_n_x;
    c4_o_x = muDoubleScalarCos(c4_o_x);
    c4_o_a = c4_chi_p[1 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_p_b = 1.0 - c4_o_x;
    c4_q_y = c4_o_a * c4_p_b;
    c4_d_A = c4_q_y;
    c4_c_B = c4_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_p_x = c4_d_A;
    c4_r_y = c4_c_B;
    c4_q_x = c4_p_x;
    c4_s_y = c4_r_y;
    c4_t_y = c4_q_x / c4_s_y;
    c4_p_a = c4_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_q_b = c4_T1;
    c4_u_y = c4_p_a * c4_q_b;
    c4_r_x = c4_u_y;
    c4_s_x = c4_r_x;
    c4_s_x = muDoubleScalarSin(c4_s_x);
    c4_q_a = c4_chi_p[3 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_r_b = c4_s_x;
    c4_v_y = c4_q_a * c4_r_b;
    c4_e_A = c4_v_y;
    c4_d_B = c4_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_t_x = c4_e_A;
    c4_w_y = c4_d_B;
    c4_u_x = c4_t_x;
    c4_x_y = c4_w_y;
    c4_y_y = c4_u_x / c4_x_y;
    c4_chi_m_p[2 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_m_p",
                         (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) -
                        1)] = (c4_t_y + c4_chi_p[2 + 5 * ((int32_T)(real_T)
      _SFD_EML_ARRAY_BOUNDS_CHECK("chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i),
      1, 11, 2, 0) - 1)]) + c4_y_y;
    _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 12);
    c4_r_a = c4_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_s_b = c4_T1;
    c4_ab_y = c4_r_a * c4_s_b;
    c4_v_x = c4_ab_y;
    c4_w_x = c4_v_x;
    c4_w_x = muDoubleScalarSin(c4_w_x);
    c4_s_a = c4_chi_p[1 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_t_b = c4_w_x;
    c4_bb_y = c4_s_a * c4_t_b;
    c4_t_a = c4_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_u_b = c4_T1;
    c4_cb_y = c4_t_a * c4_u_b;
    c4_x_x = c4_cb_y;
    c4_y_x = c4_x_x;
    c4_y_x = muDoubleScalarCos(c4_y_x);
    c4_u_a = c4_chi_p[3 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) - 1)];
    c4_v_b = c4_y_x;
    c4_db_y = c4_u_a * c4_v_b;
    c4_chi_m_p[3 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_m_p",
                         (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) -
                        1)] = c4_bb_y + c4_db_y;
    _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 13);
    c4_chi_m_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_m_p",
                         (int32_T)_SFD_INTEGER_CHECK("i", c4_i), 1, 11, 2, 0) -
                        1)] = c4_chi_p[4 + 5 * ((int32_T)(real_T)
      _SFD_EML_ARRAY_BOUNDS_CHECK("chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c4_i),
      1, 11, 2, 0) - 1)];
    c4_d_i++;
  ...
  for (c4_i32 = 0; c4_i32 < 55; c4_i32++) {
    c4_v_a[c4_i32] = c4_chi_m_p[c4_i32];
  }

  for (c4_i33 = 0; c4_i33 < 11; c4_i33++) {
    c4_w_b[c4_i33] = c4_Wm[c4_i33];
  }
  ...
  for (c4_i36 = 0; c4_i36 < 5; c4_i36++) {
    c4_c_a[c4_i36] = c4_x_m_p[c4_i36];
  }

  for (c4_i37 = 0; c4_i37 < 5; c4_i37++) {
    c4_x_m_p[c4_i37] = c4_c_a[c4_i37];
  }

  for (c4_i38 = 0; c4_i38 < 5; c4_i38++) {
    c4_c_a[c4_i38] = c4_x_m_p[c4_i38];
  }

  for (c4_i39 = 0; c4_i39 < 5; c4_i39++) {
    c4_x_m_p[c4_i39] = c4_c_a[c4_i39];
  }

  for (c4_i40 = 0; c4_i40 < 5; c4_i40++) {
    c4_x_m_p[c4_i40] = 0.0;
    c4_i41 = 0;
    for (c4_i42 = 0; c4_i42 < 11; c4_i42++) {
      c4_x_m_p[c4_i40] += c4_v_a[c4_i41 + c4_i40] * c4_w_b[c4_i42];
      c4_i41 += 5;
    }
  }
  ...
  for (c4_i43 = 0; c4_i43 < 5; c4_i43++) {
    (*c4_b_x_m_p)[c4_i43] = c4_x_m_p[c4_i43];
  }
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  for (c4_i44 = 0; c4_i44 < 5; c4_i44++) {
    c4_b_inData[c4_i44] = (*(real_T (*)[5])c4_inData)[c4_i44];
  }

  for (c4_i45 = 0; c4_i45 < 5; c4_i45++) {
    c4_u[c4_i45] = c4_b_inData[c4_i45];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i47 = 0; c4_i47 < 5; c4_i47++) {
    (*(real_T (*)[5])c4_outData)[c4_i47] = c4_y[c4_i47];
  }
  ...
  *c4_inData)
{
  ...
  chartInstance = (SFc4_UKFInstanceStruct *)chartInstanceVoid;
  c4_mxArrayOutData = NULL;
  for (c4_i48 = 0; c4_i48 < 11; c4_i48++) {
    c4_b_inData[c4_i48] = (*(real_T (*)[11])c4_inData)[c4_i48];
  }

  for (c4_i49 = 0; c4_i49 < 11; c4_i49++) {
  ...
  *c4_inData)
{
  ...
  for (c4_i51 = 0; c4_i51 < 5; c4_i51++) {
    for (c4_i52 = 0; c4_i52 < 5; c4_i52++) {
      c4_b_inData[c4_i52 + c4_i50] = (*(real_T (*)[25])c4_inData)[c4_i52 +
        c4_i50];
    }
  ...
  *c4_inData)
{
  ...
  for (c4_i57 = 0; c4_i57 < 11; c4_i57++) {
    for (c4_i58 = 0; c4_i58 < 5; c4_i58++) {
      c4_b_inData[c4_i58 + c4_i56] = (*(real_T (*)[55])c4_inData)[c4_i58 +
        c4_i56];
    }
  ...
  mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[55])
{
  real_T c4_dv2[55];
  int32_T c4_i62;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv2, 1, 0, 0U, 1, 0U, 2, 5, 11);
  for (c4_i62 = 0; c4_i62 < 55; c4_i62++) {
    c4_y[c4_i62] = c4_dv2[c4_i62];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i64 = 0; c4_i64 < 11; c4_i64++) {
    for (c4_i65 = 0; c4_i65 < 5; c4_i65++) {
      (*(real_T (*)[55])c4_outData)[c4_i65 + c4_i63] = c4_y[c4_i65 + c4_i63];
    }
  ...
  mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[25])
{
  real_T c4_dv3[25];
  int32_T c4_i66;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv3, 1, 0, 0U, 1, 0U, 2, 5, 5);
  for (c4_i66 = 0; c4_i66 < 25; c4_i66++) {
    c4_y[c4_i66] = c4_dv3[c4_i66];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  c4_i67 = 0;
  for (c4_i68 = 0; c4_i68 < 5; c4_i68++) {
    for (c4_i69 = 0; c4_i69 < 5; c4_i69++) {
      (*(real_T (*)[25])c4_outData)[c4_i69 + c4_i67] = c4_y[c4_i69 + c4_i67];
    }
...
const mxArray *sf_c4_UKF_get_eml_resolved_functions_info(void)
{
  ...
  sf_mex_assign(&c4_nameCaptureInfo, sf_mex_createstruct("structure", 2, 79, 1),
                FALSE);
...
static void c4_info_helper(const mxArray **c4_info)
{
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                  "resolved", "resolved", 4);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1346542740U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/chol.m!cholesky"),
                  "context", "context", 6);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("eml_error"), "name", "name", 6);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1286851178U), "fileTimeLo",
                  "fileTimeLo", 13);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 13);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1286851180U), "fileTimeLo",
                  "fileTimeLo", 15);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 15);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1299109168U), "fileTimeLo",
                  "fileTimeLo", 20);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 20);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xdotc.m"), "context",
                  "context", 21);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("eml_xdot"), "name", "name", 21);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 21);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xdot.m"), "resolved",
                  "resolved", 21);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1363742668U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xdot.m!below_threshold"),
                  "context", "context", 23);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("length"), "name", "name", 23);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 23);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1299109172U), "fileTimeLo",
                  "fileTimeLo", 26);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 26);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1360314750U), "fileTimeLo",
                  "fileTimeLo", 27);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 27);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemv.m!below_threshold"),
                  "context", "context", 36);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("length"), "name", "name", 36);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 36);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m"), "resolved",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemv.m!below_threshold"),
                  "context", "context", 37);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("intmax"), "name", "name", 37);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 37);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemv.m!below_threshold"),
                  "context", "context", 38);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("mtimes"), "name", "name", 38);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 38);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemv.m"),
                  "context", "context", 42);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("eml_refblas_xgemv"), "name",
                  "name", 42);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 42);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1360314752U), "fileTimeLo",
                  "fileTimeLo", 42);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 42);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zpotrf.m"),
                  "context", "context", 48);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("eml_div"), "name", "name", 48);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 48);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
                  "resolved", 48);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1363742666U), "fileTimeLo",
                  "fileTimeLo", 48);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 48);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1363742672U), "fileTimeLo",
                  "fileTimeLo", 49);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 49);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xscal.m!below_threshold"),
                  "context", "context", 51);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("length"), "name", "name", 51);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 51);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m"), "resolved",
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xscal.m"),
                  "context", "context", 54);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("eml_refblas_xscal"), "name",
                  "name", 54);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 54);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1299109184U), "fileTimeLo",
                  "fileTimeLo", 54);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 54);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 57);
  sf_mex_assign(&c4_rhs57, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs57, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 58);
  sf_mex_assign(&c4_rhs58, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs58, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 59);
  sf_mex_assign(&c4_rhs59, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs59, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 60);
  sf_mex_assign(&c4_rhs60, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs60, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, sf_mex_duplicatearraysafe(&c4_lhs60), "lhs", "lhs",
                  60);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(""), "context", "context", 61);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("mtimes"), "name", "name", 61);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 61);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 61);
  sf_mex_assign(&c4_rhs61, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs61, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, sf_mex_duplicatearraysafe(&c4_lhs61), "lhs", "lhs",
                  61);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(""), "context", "context", 62);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("sin"), "name", "name", 62);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 62);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 62);
  sf_mex_assign(&c4_rhs62, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs62, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 63);
  sf_mex_assign(&c4_rhs63, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs63, sf_mex_createcellarray(0), FALSE);
...
static void c4_b_info_helper(const mxArray **c4_info)
{
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(""), "context", "context", 64);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("mrdivide"), "name", "name", 64);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 64);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
                  "resolved", 64);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1373338908U), "fileTimeLo",
                  "fileTimeLo", 64);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 64);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(1319762366U), "mFileTimeLo",
                  "mFileTimeLo", 64);
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 64);
  sf_mex_assign(&c4_rhs64, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs64, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 65);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("rdivide"), "name", "name", 65);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 65);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 65);
  sf_mex_assign(&c4_rhs65, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs65, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 66);
  sf_mex_assign(&c4_rhs66, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs66, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 67);
  sf_mex_assign(&c4_rhs67, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs67, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 68);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("eml_div"), "name", "name", 68);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 68);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 68);
  sf_mex_assign(&c4_rhs68, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs68, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, sf_mex_duplicatearraysafe(&c4_lhs68), "lhs", "lhs",
                  68);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(""), "context", "context", 69);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("cos"), "name", "name", 69);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 69);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 69);
  sf_mex_assign(&c4_rhs69, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs69, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 70);
  sf_mex_assign(&c4_rhs70, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs70, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 71);
  sf_mex_assign(&c4_rhs71, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs71, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 72);
  sf_mex_assign(&c4_rhs72, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs72, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 73);
  sf_mex_assign(&c4_rhs73, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs73, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 74);
  sf_mex_assign(&c4_rhs74, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs74, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m!below_threshold"),
                  "context", "context", 75);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("mtimes"), "name", "name", 75);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 75);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 75);
  sf_mex_assign(&c4_rhs75, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs75, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 76);
  sf_mex_assign(&c4_rhs76, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs76, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 77);
  sf_mex_assign(&c4_rhs77, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs77, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m"),
                  "context", "context", 78);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("eml_refblas_xgemm"), "name",
                  "name", 78);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 78);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 78);
  sf_mex_assign(&c4_rhs78, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c4_lhs78, sf_mex_createcellarray(0), FALSE);
...
static void c4_eml_error(SFc4_UKFInstanceStruct *chartInstance)
{
  ...
  char_T c4_u[48];
  const mxArray *c4_y = NULL;
  for (c4_i70 = 0; c4_i70 < 48; c4_i70++) {
    c4_u[c4_i70] = c4_cv0[c4_i70];
  }
...
{
  int32_T c4_i74;
  for (c4_i74 = 0; c4_i74 < 25; c4_i74++) {
    c4_b_y[c4_i74] = c4_y[c4_i74];
  }
...
static void c4_b_eml_error(SFc4_UKFInstanceStruct *chartInstance)
{
  ...
  char_T c4_u[19];
  const mxArray *c4_y = NULL;
  for (c4_i75 = 0; c4_i75 < 19; c4_i75++) {
    c4_u[c4_i75] = c4_cv3[c4_i75];
  }
  ...
  while ((exitg1 == FALSE) && (c4_j < 6)) {
    ...
    if (c4_e_n < 1) {
      ...
      for (c4_k = 1; c4_k <= c4_f_n; c4_k++) {
        c4_d += c4_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", (real_T)c4_ix), 1, 25, 1, 0) - 1] *
          c4_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
          (real_T)c4_iy), 1, 25, 1, 0) - 1];
        c4_d_a = c4_ix + 5;
        c4_ix = c4_d_a;
        c4_e_a = c4_iy + 5;
        c4_iy = c4_e_a;
    ...
    if (c4_ajj > 0.0) {
      ...
      if (c4_b_j < 5) {
        ...
        for (c4_b_k = 1; c4_b_k <= c4_b_jm1; c4_b_k++) {
          c4_c_k = c4_b_k;
          c4_A[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                  (real_T)c4_b_j), 1, 5, 1, 0) + 5 *
                (_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                   (real_T)c4_c_k), 1, 5, 2, 0) - 1)) - 1] = c4_A
            [(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                (real_T)c4_b_j), 1, 5, 1, 0) + 5 * (_SFD_EML_ARRAY_BOUNDS_CHECK(
                "", (int32_T)_SFD_INTEGER_CHECK("", (real_T)c4_c_k), 1, 5, 2, 0)
               - 1)) - 1];
        }
        ...
        for (c4_d_k = 1; c4_d_k <= c4_c_jm1; c4_d_k++) {
          c4_c_k = c4_d_k;
          c4_A[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                  (real_T)c4_b_j), 1, 5, 1, 0) + 5 *
                (_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
        ...
        if (c4_n_a > c4_l_b) {
          ...
          c4_d_overflow = (c4_l_b > 2147483646);
        }
        ...
        for (c4_e_k = c4_i_ix0; c4_e_k <= c4_i77; c4_e_k++) {
          c4_f_k = c4_e_k;
          c4_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c4_f_k), 1, 25, 1, 0) - 1] = c4_j_a *
            c4_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c4_f_k), 1, 25, 1, 0) - 1];
        }
      }
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_UKFInstanceStruct *chartInstance;
    chartInstance = (SFc4_UKFInstanceStruct *) ((ChartInfoStruct *)
...
{
  sf_c4_UKF((SFc4_UKFInstanceStruct*) chartInstanceVar);
}
...
static void mdlProcessParameters_c4_UKF(SimStruct *S)
{
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_UKF((SFc4_UKFInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}
