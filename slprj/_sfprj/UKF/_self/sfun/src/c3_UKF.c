...
static void sf_c3_UKF(SFc3_UKFInstanceStruct *chartInstance);
...
static void c3_b_eml_scalar_eg(SFc3_UKFInstanceStruct *chartInstance);
...
static void c3_chartstep_c3_UKF(SFc3_UKFInstanceStruct *chartInstance)
{
  ...
  c3_ab_x = (real_T (*)[5])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c3_i12 = 0; c3_i12 < 5; c3_i12++) {
    c3_c_a[c3_i12] = c3_x[c3_i12];
  }

  for (c3_i13 = 0; c3_i13 < 5; c3_i13++) {
    c3_i14 = 0;
    for (c3_i15 = 0; c3_i15 < 5; c3_i15++) {
      c3_A[c3_i14 + c3_i13] = c3_c_a[c3_i13];
      c3_i14 += 5;
    }
  }
  ...
  while (c3_d_i < 11) {
    ...
    c3_f_a = c3_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_g_b = c3_T1;
    c3_b_y = c3_f_a * c3_g_b;
    c3_b_x = c3_b_y;
    c3_c_x = c3_b_x;
    c3_c_x = muDoubleScalarSin(c3_c_x);
    c3_g_a = c3_chi_p[1 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_h_b = c3_c_x;
    c3_c_y = c3_g_a * c3_h_b;
    c3_b_A = c3_c_y;
    c3_B = c3_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_d_x = c3_b_A;
    c3_d_y = c3_B;
    c3_e_x = c3_d_x;
    c3_e_y = c3_d_y;
    c3_f_y = c3_e_x / c3_e_y;
    c3_h_a = c3_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_i_b = c3_T1;
    c3_g_y = c3_h_a * c3_i_b;
    c3_f_x = c3_g_y;
    c3_g_x = c3_f_x;
    c3_g_x = muDoubleScalarCos(c3_g_x);
    c3_i_a = c3_chi_p[3 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_j_b = 1.0 - c3_g_x;
    c3_h_y = c3_i_a * c3_j_b;
    c3_c_A = c3_h_y;
    c3_b_B = c3_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_h_x = c3_c_A;
    c3_i_y = c3_b_B;
    c3_i_x = c3_h_x;
    c3_j_y = c3_i_y;
    c3_k_y = c3_i_x / c3_j_y;
    c3_chi_m_p[5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_m_p",
      (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)] = (c3_chi_p[5 *
      ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_p", (int32_T)
      _SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)] + c3_f_y) - c3_k_y;
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 10);
    c3_j_a = c3_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_k_b = c3_T1;
    c3_l_y = c3_j_a * c3_k_b;
    c3_j_x = c3_l_y;
    c3_k_x = c3_j_x;
    c3_k_x = muDoubleScalarCos(c3_k_x);
    c3_k_a = c3_k_x;
    c3_l_b = c3_chi_p[1 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_m_y = c3_k_a * c3_l_b;
    c3_l_a = c3_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_m_b = c3_T1;
    c3_n_y = c3_l_a * c3_m_b;
    c3_l_x = c3_n_y;
    c3_m_x = c3_l_x;
    c3_m_x = muDoubleScalarSin(c3_m_x);
    c3_m_a = c3_m_x;
    c3_n_b = c3_chi_p[3 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_o_y = c3_m_a * c3_n_b;
    c3_chi_m_p[1 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_m_p",
                         (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) -
                        1)] = c3_m_y - c3_o_y;
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 11);
    c3_n_a = c3_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_o_b = c3_T1;
    c3_p_y = c3_n_a * c3_o_b;
    c3_n_x = c3_p_y;
    c3_o_x = c3_n_x;
    c3_o_x = muDoubleScalarCos(c3_o_x);
    c3_o_a = c3_chi_p[1 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_p_b = 1.0 - c3_o_x;
    c3_q_y = c3_o_a * c3_p_b;
    c3_d_A = c3_q_y;
    c3_c_B = c3_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_p_x = c3_d_A;
    c3_r_y = c3_c_B;
    c3_q_x = c3_p_x;
    c3_s_y = c3_r_y;
    c3_t_y = c3_q_x / c3_s_y;
    c3_p_a = c3_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_q_b = c3_T1;
    c3_u_y = c3_p_a * c3_q_b;
    c3_r_x = c3_u_y;
    c3_s_x = c3_r_x;
    c3_s_x = muDoubleScalarSin(c3_s_x);
    c3_q_a = c3_chi_p[3 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_r_b = c3_s_x;
    c3_v_y = c3_q_a * c3_r_b;
    c3_e_A = c3_v_y;
    c3_d_B = c3_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_t_x = c3_e_A;
    c3_w_y = c3_d_B;
    c3_u_x = c3_t_x;
    c3_x_y = c3_w_y;
    c3_y_y = c3_u_x / c3_x_y;
    c3_chi_m_p[2 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_m_p",
                         (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) -
                        1)] = (c3_t_y + c3_chi_p[2 + 5 * ((int32_T)(real_T)
      _SFD_EML_ARRAY_BOUNDS_CHECK("chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i),
      1, 11, 2, 0) - 1)]) + c3_y_y;
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 12);
    c3_r_a = c3_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_s_b = c3_T1;
    c3_ab_y = c3_r_a * c3_s_b;
    c3_v_x = c3_ab_y;
    c3_w_x = c3_v_x;
    c3_w_x = muDoubleScalarSin(c3_w_x);
    c3_s_a = c3_chi_p[1 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_t_b = c3_w_x;
    c3_bb_y = c3_s_a * c3_t_b;
    c3_t_a = c3_chi_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_u_b = c3_T1;
    c3_cb_y = c3_t_a * c3_u_b;
    c3_x_x = c3_cb_y;
    c3_y_x = c3_x_x;
    c3_y_x = muDoubleScalarCos(c3_y_x);
    c3_u_a = c3_chi_p[3 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) - 1)];
    c3_v_b = c3_y_x;
    c3_db_y = c3_u_a * c3_v_b;
    c3_chi_m_p[3 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_m_p",
                         (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) -
                        1)] = c3_bb_y + c3_db_y;
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 13);
    c3_chi_m_p[4 + 5 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("chi_m_p",
                         (int32_T)_SFD_INTEGER_CHECK("i", c3_i), 1, 11, 2, 0) -
                        1)] = c3_chi_p[4 + 5 * ((int32_T)(real_T)
      _SFD_EML_ARRAY_BOUNDS_CHECK("chi_p", (int32_T)_SFD_INTEGER_CHECK("i", c3_i),
      1, 11, 2, 0) - 1)];
    c3_d_i++;
  ...
  for (c3_i32 = 0; c3_i32 < 55; c3_i32++) {
    c3_v_a[c3_i32] = c3_chi_m_p[c3_i32];
  }

  for (c3_i33 = 0; c3_i33 < 11; c3_i33++) {
    c3_w_b[c3_i33] = c3_Wm[c3_i33];
  }
  ...
  for (c3_i36 = 0; c3_i36 < 5; c3_i36++) {
    c3_c_a[c3_i36] = c3_x_m_p[c3_i36];
  }

  for (c3_i37 = 0; c3_i37 < 5; c3_i37++) {
    c3_x_m_p[c3_i37] = c3_c_a[c3_i37];
  }

  for (c3_i38 = 0; c3_i38 < 5; c3_i38++) {
    c3_c_a[c3_i38] = c3_x_m_p[c3_i38];
  }

  for (c3_i39 = 0; c3_i39 < 5; c3_i39++) {
    c3_x_m_p[c3_i39] = c3_c_a[c3_i39];
  }

  for (c3_i40 = 0; c3_i40 < 5; c3_i40++) {
    c3_x_m_p[c3_i40] = 0.0;
    c3_i41 = 0;
    for (c3_i42 = 0; c3_i42 < 11; c3_i42++) {
      c3_x_m_p[c3_i40] += c3_v_a[c3_i41 + c3_i40] * c3_w_b[c3_i42];
      c3_i41 += 5;
    }
  }
  ...
  for (c3_i43 = 0; c3_i43 < 5; c3_i43++) {
    (*c3_b_x_m_p)[c3_i43] = c3_x_m_p[c3_i43];
  }
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  for (c3_i44 = 0; c3_i44 < 5; c3_i44++) {
    c3_b_inData[c3_i44] = (*(real_T (*)[5])c3_inData)[c3_i44];
  }

  for (c3_i45 = 0; c3_i45 < 5; c3_i45++) {
  ...
  mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[5])
{
  real_T c3_dv1[5];
  int32_T c3_i46;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv1, 1, 0, 0U, 1, 0U, 1, 5);
  for (c3_i46 = 0; c3_i46 < 5; c3_i46++) {
    c3_y[c3_i46] = c3_dv1[c3_i46];
  }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  for (c3_i47 = 0; c3_i47 < 5; c3_i47++) {
    (*(real_T (*)[5])c3_outData)[c3_i47] = c3_y[c3_i47];
  }
  ...
  *c3_inData)
{
  ...
  for (c3_i48 = 0; c3_i48 < 11; c3_i48++) {
    c3_b_inData[c3_i48] = (*(real_T (*)[11])c3_inData)[c3_i48];
  }
  ...
  *c3_inData)
{
  ...
  for (c3_i51 = 0; c3_i51 < 5; c3_i51++) {
    for (c3_i52 = 0; c3_i52 < 5; c3_i52++) {
      c3_b_inData[c3_i52 + c3_i50] = (*(real_T (*)[25])c3_inData)[c3_i52 +
        c3_i50];
    }
  ...
  *c3_inData)
{
  ...
  for (c3_i57 = 0; c3_i57 < 11; c3_i57++) {
    for (c3_i58 = 0; c3_i58 < 5; c3_i58++) {
      c3_b_inData[c3_i58 + c3_i56] = (*(real_T (*)[55])c3_inData)[c3_i58 +
        c3_i56];
    }
  ...
  c3_i59 = 0;
  for (c3_i60 = 0; c3_i60 < 11; c3_i60++) {
    for (c3_i61 = 0; c3_i61 < 5; c3_i61++) {
      c3_u[c3_i61 + c3_i59] = c3_b_inData[c3_i61 + c3_i59];
    }
  ...
  mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[55])
{
  real_T c3_dv2[55];
  int32_T c3_i62;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv2, 1, 0, 0U, 1, 0U, 2, 5, 11);
  for (c3_i62 = 0; c3_i62 < 55; c3_i62++) {
    c3_y[c3_i62] = c3_dv2[c3_i62];
  }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  c3_i63 = 0;
  for (c3_i64 = 0; c3_i64 < 11; c3_i64++) {
    for (c3_i65 = 0; c3_i65 < 5; c3_i65++) {
      (*(real_T (*)[55])c3_outData)[c3_i65 + c3_i63] = c3_y[c3_i65 + c3_i63];
    }
  ...
  mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[25])
{
  real_T c3_dv3[25];
  int32_T c3_i66;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv3, 1, 0, 0U, 1, 0U, 2, 5, 5);
  for (c3_i66 = 0; c3_i66 < 25; c3_i66++) {
    c3_y[c3_i66] = c3_dv3[c3_i66];
  }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  for (c3_i68 = 0; c3_i68 < 5; c3_i68++) {
    for (c3_i69 = 0; c3_i69 < 5; c3_i69++) {
      (*(real_T (*)[25])c3_outData)[c3_i69 + c3_i67] = c3_y[c3_i69 + c3_i67];
    }
...
const mxArray *sf_c3_UKF_get_eml_resolved_functions_info(void)
{
  ...
  sf_mex_assign(&c3_nameCaptureInfo, sf_mex_createstruct("structure", 2, 79, 1),
                FALSE);
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                  "resolved", "resolved", 4);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1346542740U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/chol.m!cholesky"),
                  "context", "context", 6);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_error"), "name", "name", 6);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1286851178U), "fileTimeLo",
                  "fileTimeLo", 13);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 13);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1286851180U), "fileTimeLo",
                  "fileTimeLo", 15);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 15);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1299109168U), "fileTimeLo",
                  "fileTimeLo", 20);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 20);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xdotc.m"), "context",
                  "context", 21);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_xdot"), "name", "name", 21);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 21);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xdot.m"), "resolved",
                  "resolved", 21);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1363742668U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xdot.m!below_threshold"),
                  "context", "context", 23);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("length"), "name", "name", 23);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 23);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1299109172U), "fileTimeLo",
                  "fileTimeLo", 26);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 26);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemv.m!below_threshold"),
                  "context", "context", 36);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("length"), "name", "name", 36);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 36);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemv.m"),
                  "context", "context", 42);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_refblas_xgemv"), "name",
                  "name", 42);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 42);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1360314752U), "fileTimeLo",
                  "fileTimeLo", 42);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 42);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zpotrf.m"),
                  "context", "context", 48);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_div"), "name", "name", 48);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 48);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
                  "resolved", 48);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1363742666U), "fileTimeLo",
                  "fileTimeLo", 48);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 48);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1363742672U), "fileTimeLo",
                  "fileTimeLo", 49);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 49);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xscal.m!below_threshold"),
                  "context", "context", 51);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("length"), "name", "name", 51);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 51);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xscal.m"),
                  "context", "context", 54);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_refblas_xscal"), "name",
                  "name", 54);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 54);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1299109184U), "fileTimeLo",
                  "fileTimeLo", 54);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 54);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("mtimes"), "name", "name", 61);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 61);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, sf_mex_duplicatearraysafe(&c3_lhs61), "lhs", "lhs",
                  61);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(""), "context", "context", 62);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("sin"), "name", "name", 62);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 62);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
...
static void c3_b_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("mrdivide"), "name", "name", 64);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 64);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
                  "resolved", 64);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1373338908U), "fileTimeLo",
                  "fileTimeLo", 64);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 64);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1319762366U), "mFileTimeLo",
                  "mFileTimeLo", 64);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 64);
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 65);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("rdivide"), "name", "name", 65);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 65);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 68);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_div"), "name", "name", 68);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 68);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
  ...
  sf_mex_addfield(*c3_info, sf_mex_duplicatearraysafe(&c3_lhs68), "lhs", "lhs",
                  68);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(""), "context", "context", 69);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("cos"), "name", "name", 69);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 69);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m!below_threshold"),
                  "context", "context", 75);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("mtimes"), "name", "name", 75);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 75);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
...
static void c3_eml_error(SFc3_UKFInstanceStruct *chartInstance)
{
  ...
  char_T c3_u[48];
  const mxArray *c3_y = NULL;
  for (c3_i70 = 0; c3_i70 < 48; c3_i70++) {
    c3_u[c3_i70] = c3_cv0[c3_i70];
  }
  ...
  *chartInstance, boolean_T c3_overflow)
{
  ...
  if (!c3_overflow) {
    ...
    for (c3_i72 = 0; c3_i72 < 34; c3_i72++) {
      c3_u[c3_i72] = c3_cv1[c3_i72];
    }

    c3_y = NULL;
    sf_mex_assign(&c3_y, sf_mex_create("y", c3_u, 10, 0U, 1U, 0U, 2, 1, 34),
                  FALSE);
    for (c3_i73 = 0; c3_i73 < 23; c3_i73++) {
      c3_b_u[c3_i73] = c3_cv2[c3_i73];
    }
...
{
  int32_T c3_i74;
  for (c3_i74 = 0; c3_i74 < 25; c3_i74++) {
    c3_b_y[c3_i74] = c3_y[c3_i74];
  }
...
static void c3_b_eml_error(SFc3_UKFInstanceStruct *chartInstance)
{
  ...
  char_T c3_u[19];
  const mxArray *c3_y = NULL;
  for (c3_i75 = 0; c3_i75 < 19; c3_i75++) {
    c3_u[c3_i75] = c3_cv3[c3_i75];
  }
  ...
  while ((exitg1 == FALSE) && (c3_j < 6)) {
    ...
    if (c3_e_n < 1) {
      ...
      for (c3_k = 1; c3_k <= c3_f_n; c3_k++) {
        c3_d += c3_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", (real_T)c3_ix), 1, 25, 1, 0) - 1] *
          c3_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
          (real_T)c3_iy), 1, 25, 1, 0) - 1];
        c3_d_a = c3_ix + 5;
        c3_ix = c3_d_a;
        c3_e_a = c3_iy + 5;
        c3_iy = c3_e_a;
    ...
    if (c3_ajj > 0.0) {
      ...
      if (c3_b_j < 5) {
        ...
        for (c3_b_k = 1; c3_b_k <= c3_b_jm1; c3_b_k++) {
          c3_c_k = c3_b_k;
          c3_A[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                  (real_T)c3_b_j), 1, 5, 1, 0) + 5 *
                (_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                   (real_T)c3_c_k), 1, 5, 2, 0) - 1)) - 1] = c3_A
            [(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                (real_T)c3_b_j), 1, 5, 1, 0) + 5 * (_SFD_EML_ARRAY_BOUNDS_CHECK(
                "", (int32_T)_SFD_INTEGER_CHECK("", (real_T)c3_c_k), 1, 5, 2, 0)
               - 1)) - 1];
        }
        ...
        for (c3_d_k = 1; c3_d_k <= c3_c_jm1; c3_d_k++) {
          c3_c_k = c3_d_k;
          c3_A[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
                  (real_T)c3_b_j), 1, 5, 1, 0) + 5 *
                (_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
        ...
        if (c3_n_a > c3_l_b) {
          ...
          c3_d_overflow = (c3_l_b > 2147483646);
        }
        ...
        for (c3_e_k = c3_i_ix0; c3_e_k <= c3_i77; c3_e_k++) {
          c3_f_k = c3_e_k;
          c3_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c3_f_k), 1, 25, 1, 0) - 1] = c3_j_a *
            c3_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c3_f_k), 1, 25, 1, 0) - 1];
        }
      }
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_UKFInstanceStruct *chartInstance;
    chartInstance = (SFc3_UKFInstanceStruct *) ((ChartInfoStruct *)
...
{
  sf_c3_UKF((SFc3_UKFInstanceStruct*) chartInstanceVar);
}
...
static void mdlProcessParameters_c3_UKF(SimStruct *S)
{
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_UKF((SFc3_UKFInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}
